...
for k, v in pairs(t.menu_info) do
	if not k:match('_itemname_') then --"t.trials_info[k] == nil and" was placed before the condition 
		t.trials_info[k] = v
	end
end
...
--trialsbgdef section reuses menubgdef values if not defined
if t.trialsbgdef == nil then
	t.trialsbgdef = t.menubgdef
end
...
for _, v in ipairs({'title_info', 'select_info', 'vs_screen', 'demo_mode', 'continue_screen', 'victory_screen', 'win_screen', 'survival_results_screen', 'time_attack_results_screen', 'boss_rush_results_screen', 'option_info', 'replay_info', 'menu_info', 'training_info', 'trials_mode', 'attract_mode', 'challenger_info', 'hiscore_info'}) do
