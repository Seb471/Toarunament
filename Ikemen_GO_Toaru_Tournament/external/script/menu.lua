...
menu.t_itemname = {
	...
	--Trials text boxes ?
	['trialstextboxes'] = function(t, item, cursorPosY, moveTxt, section)
		if f_valueChanged(t.items[item], motif[section]) then
	...
	--Trials layout ?
	['trialslayout'] = function(t, item, cursorPosY, moveTxt, section)
		if f_valueChanged(t.items[item], motif[section]) then
...
function menu.f_vardisplay(itemname)
	...
	if itemname == 'trialslist' then return menu.t_valuename.trialslist[menu.trialslist or 1].displayname end
	if itemname == 'trialsadvancement' then return menu.t_valuename.trialsadvancement[menu.trialsadvancement or 1].displayname end
	if itemname == 'trialslayout' then return menu.t_valuename.trialslayout[menu.trialslayout or 1].displayname end
	if itemname == 'trialsresetonsuccess' then return menu.t_valuename.trialsresetonsuccess[menu.trialsresetonsuccess or 1].displayname end
	if itemname == 'trialstextboxes' then return menu.t_valuename.trialstextboxes[menu.trialstextboxes or 1].displayname end
	return ''
end
